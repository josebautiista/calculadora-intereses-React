export const calcular = (
  ...
  cuotaManejo =
    typeof cuotaManejo === "string" && cuotaManejo.trim() !== ""
      ? parseFloat(cuotaManejo.replace(/\./g, ""))
      : 0;
  cargos =
    typeof cargos === "string" && cargos.trim() !== ""
      ? parseFloat(cargos.replace(/\./g, ""))
      : 0;
  ...
  for (let i = 0; i < cuotas; i++) {
    ...
    setResultados((prevState) => [
      ...prevState,
      {
        ...
        interesMensual:
          i === 0 ? diasHataCorte.toFixed(2) : interesMensual.toFixed(2),
